...
uint8_t flag_delay_lock, flag_delay_unlock, flag_batlock, flag_motorlock, flag_motorlock2;
uint8_t flag_delay500ms, flag_delay900ms, flag_delay10ms, flag_delay4s; 
uint8_t f_motorlock;
